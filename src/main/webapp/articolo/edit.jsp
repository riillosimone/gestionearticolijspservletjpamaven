			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    <div class='card-header'>
				        <h5>Vuoi modificare questo elemento?</h5> 
				    </div>
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteEditArticoloServlet" class="row g-3" novalidate="novalidate">
							
								<% Articolo articoloInPagina = (Articolo)request.getAttribute("articoloDaInviareAPaginaEdit"); %>
							...
							<div class="col-12">
								...
								<input type="hidden" name="idArticoloToEdit" value="<%=articoloInPagina.getId()%>">
